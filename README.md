# AI-StoryLab
[![smithery badge](https://smithery.ai/badge/@aigc17/al-storylab)](https://smithery.ai/server/@aigc17/al-storylab)
...
To install AI-StoryLab for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@aigc17/al-storylab):

```bash
npx -y @smithery/cli install @aigc17/al-storylab --client claude
```
